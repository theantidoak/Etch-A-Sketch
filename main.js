...
const toggle = document.querySelector(".toggle-on");
...
function colorIt() {
  if (friendlyFire) {
    if (friendlyFire && flag && ((this.style.backgroundColor == "white") 
    || (this.style.backgroundColor == "black" && colorChange.value == "shades-of-grey"))) {
